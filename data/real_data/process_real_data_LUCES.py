...
pixel_coords[:, :, 0] = pixel_coords[:, :, 0] * (sensor_w / 2) * depth_gt / focal_len
pixel_coords[:, :, 1] = pixel_coords[:, :, 1] * (sensor_h / 2) * depth_gt / focal_len
...
np.save(os.path.join(save_dir, 'point_set_world.npy'), point_set_world)

from hutils.draw_3D import generate_mesh
point_3d_name = os.path.join(save_dir, 'shape.png')
