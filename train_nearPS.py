...
p.add_argument('--data_folder', type=str, default='/mnt/workspace2020/heng/project/data/output_dir_near_light/09_reading/perspective/lambertian/scale_512_512/wo_castshadow/shading/crop_to_size_256', help='Path to data')
